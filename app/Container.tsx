    ...
    <div className="lg:pt-16 pt-4 relative w-10/12 mx-auto">
        <div className='md:flex items-center justify-between flex-row-reverse'>
            ...
            <div className='p-4 pl-0 mt-5 sm:mt-20'>
                ...
                <h1 className='text-4xl sm:text-5xl md:text-4xl lg:text-5xl xl:text-6xl pt-2  lg:pt-6'>I&apos;m Sankha<p className='text-xl sm:text-2xl md:text-xl lg:text-2xl xl:text-3xl py-4'>A Full Stack Web-Developer </p></h1>
                ...
                <div className='flex items-center mt-6 md:mt-14'>
                    ...
                    <a href="mailto:sankhasubhradas1@gmail.com" className='px-4 py-[5px] whitespace-nowrap transition ease-in duration-150 bg-neutral-700 hover:bg-neutral-600 rounded-2xl border-[0.5px] border-[#363636]'>Email me</a>
                </div>
            </div>
        </div>
    </div>
