  ...
  return (
    <div className='w-10/12 mx-auto'>
        ...
        <div className='mt-20 md:w-9/12 mx-auto '>
            <img className='rounded-xl opacity-90' src="portfolio.png" alt="" />
            <div className='my-10 sm:w-10/12 mx-auto'>
                <h1 className='text-2xl font-bold mb-4'>A portfolio Project</h1>
                <div className='text-neutral-300'>A portfolio website for beginers made with basic html, css and js with great color combination and few interactive features</div>
                <div className='mt-6 inline-block'><a href="https://sankha1545.github.io/PORTFOLIO/" className='flex items-center px-4 py-1 border-[0.5px] border-slate-500 rounded-3xl bg-neutral-800 hover:bg-neutral-700'>Explore <BsArrowUpRight size={14} className='ml-2'/></a></div>
            </div>
        </div>
        <div className='mt-20 md:w-9/12 mx-auto '>
            <img className='rounded-xl opacity-90' src="E-commerce.png" alt="" />
            <div className='my-10 sm:w-10/12 mx-auto'>
                <h1 className='text-2xl font-bold mb-4'>F A C T O R Y (An E-Commerce Website)</h1>
        ...
        <div className='mt-20 md:w-9/12 mx-auto '>
            <img className='rounded-xl opacity-90' src="hotel.png" alt="" />
            <div className='my-10 sm:w-10/12 mx-auto'>
                <h1 className='text-2xl font-bold mb-4'>The Velvet Viesta ( Hotel Website)</h1>
